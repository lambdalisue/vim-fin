...
execute join(['function! vital#_fin#App#Args#import() abort', printf("return map({'set': '', 'pop': '', 'get': '', 'throw_if_dirty': ''}, \"vital#_fin#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
